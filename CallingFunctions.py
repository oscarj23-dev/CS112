...
"""
#creates a list of numbers which are multiples of 3, between 3 and 50
num = createList(3, 51, 3)
#prints the list
printList(num)
#finds index of minimum value and unpacks them
small, index = minValue(num)
#finds index of maximum value and unpacks them
large, location = maxValue(num)
#prints the minimum value and index
printResults(0, small, index)
#the maximum value and index
printResults(1,large, location)
